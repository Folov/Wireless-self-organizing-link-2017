...
if [[ $? -ne 0 ]]; then
	...
	echo "export Self_id=45" >> /etc/profile
	echo "export SSID=openwrt45" >> /etc/profile
	echo "export SSID_num=45" >> /etc/profile
	...
	echo "export WAN_IP=192.168.12.45" >> /etc/profile
	echo "export LAN_IP=192.168.45.45" >> /etc/profile
